...
test('Cache TTL - In-memory/Temporarily mode', async t => {
  ...
  const getOrSetAsync = await cache.getOrSet('async-get-or-set-key-1', getOrSetFn1, 1000);

  t.is(cache.get('key-a'), 'value-1', 'Function value passed .set method not works properly');
  t.is(cache.get('key-b'), 'value-b', 'Primitive value passed .set method not works properly');
  t.is(cache.get('key-c'), 'value-live-long', 'Value without expiration not works properly');
  t.not(
    cache.get('key-d'),
    'some-old-value',
  ...
  t.is(asyncPromiseKey1, 'async-promise-value-1', 'Async -> Promise value not works properly');
  t.is(promiseAsyncKey1, 'promise-async-value-1', 'Promise -> Async value not works properly');
  t.is(
    promisePromiseKey1,
    'promise-promise-value-1',
    'Promise -> Promise value not works properly'
  );
  t.is(getOrSetAsync, 'async-get-or-set-value-1', 'Async -> GetOrSet works properly');
  t.log('Cache saved successfully and storing correctly');

  await timeout(1000);

  t.is(cache.has('key-a'), true, 'Function value passed .set method not works properly after 2s');

  t.is(cache.has('key-b'), false, 'Primitive value passed .set method not works properly after 2s');
  t.is(cache.has('key-c'), true, 'Value without expiration not works properly after 2s');
  t.is(cache.get('key-e'), 'value-e', 'Value with 25sec expiration not works properly after 2s');
  t.is(cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 2s');
  t.is(cache.get('async-key-1'), 'async-value-1', 'Async value not works properly after 2s');
  t.is(
  ...
  t.is(cache.has('key-a'), true, 'Function value passed .set method not works properly after 4s');
  t.is(cache.has('key-b'), false, 'Primitive value passed .set method not works properly after 4s');
  t.is(cache.has('key-c'), true, 'Value without expiration not works properly after 4s');
  t.is(cache.get('key-e'), 'value-e', 'Value with 25sec expiration not works properly after 4s');
  t.is(cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 4s');
  t.log('Cache saving after 4s works properly');

  await timeout(1000);

  t.is(cache.has('key-a'), false, 'Function value passed .set method not works properly after 5s');
  t.is(cache.has('key-b'), false, 'Primitive value passed .set method not works properly after 5s');
  t.is(cache.has('key-c'), true, 'Value without expiration not works properly after 5s');
  t.not(cache.get('key-e'), 'value-e', 'Value with 25sec expiration not works properly after 5s');
  t.is(cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 5s');
  t.log('Cache saving after 5s works properly');

  await timeout(1000);

  t.is(cache.has('key-a'), false, 'Function value passed .set method not works properly after 6s');
  t.is(cache.has('key-b'), false, 'Primitive value passed .set method not works properly after 6s');
  t.is(cache.has('key-c'), true, 'Value without expiration not works properly after 6s');
  t.not(cache.get('key-e'), 'value-e', 'Value with 25sec expiration not works properly after 6s');
  t.is(cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 6s');
  t.log('Cache saving after 6s works properly');

  cache.delete('key-c');

  t.is(cache.has('key-c'), false, 'Deleting cache item not works properly');
  t.is(cache.has('key-e'), false, 'Value with 25sec expiration not works properly after 6s');
...
test('Cache TTL - Persistent File-caching mode', async t => {
  ...
  t.is(await cache.get('key-a'), 'value-1', 'Function value passed .set method not works properly');
  t.is(
    await cache.get('key-b'),
    'value-b',
    'Primitive value passed .set method not works properly'
  );
  t.is(await cache.get('key-c'), 'value-live-long', 'Value without expiration not works properly');
  t.not(
  ...
  t.is(await cache.has('key-c'), true, 'Value without expiration not works properly after 2s');
  t.is(
    await cache.get('key-e'),
    'value-e',
    'Value with 25sec expiration not works properly after 2s'
  );
  t.is(await cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 2s');
  t.is(await cache.get('async-key-1'), 'async-value-1', 'Async value not works properly after 2s');
  t.is(
  ...
  t.is(await cache.has('key-c'), true, 'Value without expiration not works properly after 4s');
  t.is(
    await cache.get('key-e'),
    'value-e',
    'Value with 25sec expiration not works properly after 4s'
  );
  t.is(await cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 4s');
  t.log('Cache saving after 4s works properly');
  ...
  t.is(await cache.has('key-c'), true, 'Value without expiration not works properly after 5s');
  ...
  t.is(await cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 5s');
  t.log('Cache saving after 5s works properly');
  ...
  t.is(await cache.has('key-c'), true, 'Value without expiration not works properly after 6s');
  t.not(
    await cache.get('key-e'),
    'value-e',
    'Value with 25sec expiration not works properly after 6s'
  );
  t.is(await cache.get('key-f'), 'value-f', 'Value without expiration not works properly after 6s');
  t.log('Cache saving after 6s works properly');

  await cache.delete('key-c');

  t.is(await cache.has('key-c'), false, 'Deleting cache item not works properly');
  t.is(await cache.has('key-e'), false, 'Value with 25sec expiration not works properly after 6s');
